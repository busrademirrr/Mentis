...
const MOCK_CONVERSATIONS = [
    ...
    {
        id: '2',
        user: { name: 'Friedrich Nietzsche', avatar: 'https://images.unsplash.com/photo-1589829085413-56de8ae18c73?w=200' },
        lastMessage: 'Amor Fati! Bunu asla unutma.',
        timestamp: 'Dün',
        unreadCount: 0,
    },
    {
        id: '3',
        user: { name: 'Marie Curie', avatar: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?w=200' },
        lastMessage: 'Laboratuvar sonuçlarını inceledin mi?',
        timestamp: 'Pzt',
        unreadCount: 1,
    },
    {
        id: '4',
        user: { name: 'Albert Camus', avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=200' },
        lastMessage: 'Yarın kahve içelim mi?',
        timestamp: 'Pzt',
        unreadCount: 0,
    }
];

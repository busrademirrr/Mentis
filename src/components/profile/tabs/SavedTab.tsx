...
export const SavedTab = () => {
    ...
    const filteredItems = savedItems.filter(item => {
        ...
        if (post?.type && post.type !== 'knowledge_card') return false;
        ...
        <View style={styles.container}>
            ...
            <View style={styles.collectionsContainer}>
                <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={{ paddingRight: spacing.xl }}>
                    ...
                    >
                        <Text variant="caption" weight="bold" color={activeCollection === null ? '#FFFFFF' : 'textSecondary'}>Tümü</Text>
                    </TouchableOpacity>
                    {collections.map(col => (
                        <TouchableOpacity 
                            key={col.id}
                        ...
                        >
                            <Text variant="caption" weight="bold" color={activeCollection === col.id ? '#FFFFFF' : 'textSecondary'}>
                                {col.title}
                            </Text>
                        </TouchableOpacity>
                    ))}
            ...
            {loading ? (
                ...
                <View style={styles.emptyStateContainer}>
                    ...
                    <TouchableOpacity style={styles.emptyCtaButton}>
                        <Icon name="Compass" size={16} color="#FFFFFF" />
                        <Text variant="label" weight="bold" color="#FFFFFF" style={{ marginLeft: 8 }}>Keşfet</Text>
                    </TouchableOpacity>
                </View>
            ) : (
